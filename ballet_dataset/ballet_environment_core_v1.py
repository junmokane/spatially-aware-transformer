...
ROOM_SIZE = (33, 33)  # one square around edge will be wall.
# NOTE: we note that those positions are "not" used in the training and evaluation, it is just for generating the data.
DANCER_POSITIONS = [(2, 2),  (2, 6),  (2, 10),  (2, 14),  (2, 18),  (2, 22),  (2, 26),  (2, 30),
                    (6, 2),  (6, 6),  (6, 10),  (6, 14),  (6, 18),  (6, 22),  (6, 26),  (6, 30),
                    (10, 2), (10, 6), (10, 10), (10, 14), (10, 18), (10, 22), (10, 26), (10, 30),
                    (14, 2), (14, 6), (14, 10),                     (14, 22), (14, 26), (14, 30),
                                                                                        (18, 30),
                                                                              (22, 26), (22, 30),
                                                                              (26, 26), (26, 30),
                                                                                        (30, 30)
...
WALL_CHAR = "#"
FLOOR_CHAR = " "
RESERVED_CHARS = [AGENT_CHAR, 
                  WALL_CHAR, 
                  FLOOR_CHAR]
POSSIBLE_DANCER_CHARS = [
    chr(i) for i in range(1, 91) if chr(i) not in RESERVED_CHARS
]
  ...
  def update(self, actions, board, layers, backdrop, things, the_plot):
    if the_plot["task_phase"] == "dance" and self.is_dancing:
      ...
      if not self.dance_sequence:  # done!
        self.is_dancing = False
        the_plot["time_until_next_dance"] = the_plot["dance_delay"] + 1
    else:
...
def make_game(dancers_and_properties, dance_delay=16):
  ...
  this_game.the_plot["time_until_next_dance"] = dance_delay + 1
